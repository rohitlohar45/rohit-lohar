...
const SkillProficientBar = ({ value, logo, techLink, left, shouldShake }: PageProps) => {
	...
	return (
		<div className={`flex items-center gap-1 relative ${left ? " flex-row-reverse" : ""}`}>
			{/* Logo */}
			<a href={techLink} target="_blank" title={logo} className="flex items-center cursor-pointer">
				<motion.img
