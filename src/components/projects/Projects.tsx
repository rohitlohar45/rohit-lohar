...
import { PROJECTS_LISTS, ROHIT_GITHUB_LINK } from "../../utils/constants";
...
const Projects = () => {
	...
	const handleShowMoreClick = () => {
		setShowMore(true);
		if (showMore) {
			window.open(ROHIT_GITHUB_LINK, "_blank", "noreferrer");
		}
	};
	return (
		<section
			...
			>
				...
				<div className="flex flex-col w-full">
					...
					{PROJECTS_LISTS.slice(0, 4).map((project) => {
						return (
							<ProjectTile key={project.id} project={project} flipped={project.id % 2 !== 0} />
						);
					})}
					...
					{/* Show More button */}
					<div className={`relative h-16 flex justify-center items-center bg-white`}>
						<div
