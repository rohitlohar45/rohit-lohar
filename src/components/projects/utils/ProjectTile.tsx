...
const ProjectTile = ({ project, flipped }: PapgeProps) => {
	...
	return (
		<div className={`overflow-hidden ${isMdMedium ? cssWrapper : project.cssWrapperSm}`}>
			<div
			...
			>
				...
				>
					{/* title */}
					<motion.h3 variants={verticalMoreSkills} className="text-4xl font-black">
						{" "}
						{title}{" "}
					</motion.h3>
						...
						>
							...
							>
								<span className="flex flex-col items-center">
									<p className="">
										View source code{" "}
										<span className="hidden xxsm:inline sm:hidden md:inline"> on Github </span>
									</p>
									<motion.span
				...
				<motion.div
					...
					className={`xmmd:absolute ${
						...
						id === 0 ? "xmmd:w-3/5" : "xmmd:w-[500px] lg:w-[520px] xl:w-[650px] 2xl:w-[700px]"
